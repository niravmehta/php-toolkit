...
class Push_MD_HTML_Converter {
	...
	private static function should_preserve_element( $processor, $tag ) {
		...
		if ( ! empty( $class_attr ) && is_string( $class_attr ) ) {
			...
			// Elements with custom classes not generated by standard WordPress blocks or the Classic Editor must be preserved.
			$standard_wp_classes = array( 'has-fixed-layout', 'is-style-stripes', 'wp-block-table', 'wp-block-quote', 'wp-block-paragraph', 'wp-block-heading', 'wp-block-list', 'wp-block-code', 'aligncenter', 'alignleft', 'alignright', 'alignnone', 'alignwide', 'alignfull', 'has-text-align-center', 'has-text-align-left', 'has-text-align-right', 'has-background', 'has-text-color', 'has-large-font-size', 'wp-caption', 'wp-caption-text', 'gallery', 'gallery-item', 'gallery-icon', 'gallery-caption', 'size-full', 'size-large', 'size-medium', 'size-thumbnail', 'button', 'btn', 'cta', 'download_link' );
